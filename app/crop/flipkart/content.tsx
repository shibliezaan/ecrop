...
export default function FlipkartCropContent() {
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="text-center mb-8">
        ...
        <p className="text-[15px] text-warm-gray-500 mt-2">✓ Separate labels and invoices automatically</p>
        <p className="text-[14px] text-warm-gray-500 mt-3">
          Try also: <Link href="/crop/amazon" className="text-notion-blue hover:underline">Amazon cropper</Link> • <Link href="/crop/meesho" className="text-notion-blue hover:underline">Meesho cropper</Link>
        </p>
      </div>
      <UploadZone marketplace="flipkart" />
    </div>
  );
}